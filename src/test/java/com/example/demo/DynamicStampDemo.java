 ...
 * @Package: com.example.demo
 * @Author: Suellen
 * @CreateDate: 2022/1/4 16:12
 */
public class DynamicStampDemo {
    ...
    public static void main(String[] args) {
        ...
        //加载PDF文档
        document.loadFromFile("E:\\文件\\文档文件\\测试文件\\订单相关文档_20220104153927.pdf");
        ...
        //保存文档
        document.saveToFile("E:\\文件\\文档文件\\测试文件\\动态盖章测试.pdf");
        document.close();
    }
